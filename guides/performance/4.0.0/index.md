---
layout: sapl
title: "SAPL 4.0.0 Performance (historical)"
description: "Archived performance benchmarks for SAPL 4.0.0. See the current release page for up-to-date numbers."
noindex: true
sitemap: false
data_version: "4.0.0"
---
...
<div class="perf-note">
<strong>Historical snapshot: SAPL 4.0.0.</strong> These are the archived 4.0.0 numbers, kept for reference. For the current release see the <a href="/guides/performance/">latest performance page</a>.
</div>
